...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'voltconf.com.com'
  config.app_name = 'Voltconf.com'
  config.mailer.from = 'Voltconf.com <no-reply@voltconf.com.com>'
  ...
  #
  config.app_secret = 'YkTzRfcQLyXhzOVjQ49FD2L-9wLhRJQwWS65MT15N3-GY4zJa5TKGMOJmU0Y82O1I2k'
